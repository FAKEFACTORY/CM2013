...
void CBasePlayer::Precache( void )
{
	...
	PrecacheParticleSystem( "explosion_default_grenade" );
	PrecacheParticleSystem( "explosion_default_grenade_lots_smoke" );
	PrecacheParticleSystem( "explosion_default_grenade_trails_control" );
	// FAKEFACTORY GUNSHIP_HL
