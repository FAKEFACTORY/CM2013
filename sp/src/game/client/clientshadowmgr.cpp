...
static ConVar r_worldlight_castshadows( "r_worldlight_castshadows", "1", 0, "Allow world lights to cast shadows", true, 0, true, 1, WorldLightCastShadowCallback );
static ConVar r_worldlight_lerptime( "r_worldlight_lerptime", "0.5", 0 );
static ConVar r_worldlight_debug( "r_worldlight_debug", "0", 0 );
static ConVar r_worldlight_shortenfactor( "r_worldlight_shortenfactor", "2" , 0, "Makes shadows cast from local lights shorter" );
static ConVar r_worldlight_mincastintensity( "r_worldlight_mincastintensity", "0.3", 0, "Minimum brightness of a light to be classed as shadow casting", true, 0, false, 0 );
// FAKEFACTORY RTT SHADOWS

// FAKEFACTORY ESTRANGED
// ConVar ae_flashlightshadow("ae_flashlightshadow", "0");
// FAKEFACTORY ESTRANGED
...
void CClientShadowMgr::InitDepthTextureShadows()
{
	...
	//m_nDepthTextureResolution = r_flashlightdepthres.GetInt();
	m_nDepthTextureResolution = 4096;
	// FAKEFACTORY
