...
// FAKEFACTORY
static ConVar r_headlightfar( "r_headlightfar", "3000", 0 );
static ConVar FF_vehicle_flashlightfov_h( "FF_vehicle_flashlightfov_h", "120", 0 );
static ConVar FF_vehicle_flashlightfov_v( "FF_vehicle_flashlightfov_v", "60", 0 );
static ConVar FF_vehicle_dynamicflashlight( "FF_vehicle_dynamicflashlight", "0", 0 );
...
void CHeadlightEffect::UpdateLight( const Vector &vecPos, const Vector &vecDir, const Vector &vecRight, const Vector &vecUp, int nDistance )
{
	...
	state.m_fHorizontalFOVDegrees = FF_vehicle_flashlightfov_h.GetFloat();
	state.m_fVerticalFOVDegrees = FF_vehicle_flashlightfov_v.GetFloat();
	state.m_fQuadraticAtten = r_flashlightquadratic.GetFloat();
	state.m_fLinearAtten = r_flashlightlinear.GetFloat();
	state.m_fConstantAtten = r_flashlightconstant.GetFloat();
	state.m_Color[0] = 1.0f;
	...
	if (FF_vehicle_dynamicflashlight.GetInt()) 
	{
