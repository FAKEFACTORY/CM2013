...
// *****************************	
static ConVar	ff_ironsight_hide_quickinfo( "ff_ironsight_hide_quickinfo", "1", FCVAR_ARCHIVE, "Disables the quickinfo HUD element. Crosshair alpha should be set to zero in hudlayout.res" );
// *****************************
// FAKEFACTORY IRONSIGHT
// *****************************	
...
void CHUDQuickInfo::OnThink()
{
	...
	// FAKEFACTORY IRONSIGHT
	// *****************************	
	if (ff_ironsight_hide_quickinfo.GetInt()) 
		return;
	// *****************************
	// FAKEFACTORY IRONSIGHT
	// *****************************	
