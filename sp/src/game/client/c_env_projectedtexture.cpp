...
static ConVar mat_slopescaledepthbias_shadowmap( "mat_slopescaledepthbias_shadowmap", "3", 0 );
static ConVar mat_depthbias_shadowmap(	"mat_depthbias_shadowmap", "0.0001", 0  );
// FAKEFACTORY
