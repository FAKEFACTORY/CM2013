...
void C_BaseExplosionEffect::CreateCore( void )
{
	...
	// FAKEFACTORY
	QAngle vecAngles;
	DispatchParticleEffect( "explosion_default_grenade", m_vecOrigin, vecAngles );
	DispatchParticleEffect( "explosion_default_grenade_lots_smoke", m_vecOrigin, vecAngles );
	// FAKEFACTORY
