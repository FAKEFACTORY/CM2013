...
#include "ae_outliney_ps20.inc"

BEGIN_VS_SHADER( AEOutlineY, "Estranged Outline Shader" )
...
SHADER_DRAW
{
	SHADOW_STATE
	{
		...
		//Set Pixel shader
		DECLARE_STATIC_PIXEL_SHADER( ae_outliney_ps20 );
		SET_STATIC_PIXEL_SHADER( ae_outliney_ps20 );
	}
	DYNAMIC_STATE
	{
		...
		DECLARE_DYNAMIC_PIXEL_SHADER( ae_outliney_ps20 );
		SET_DYNAMIC_PIXEL_SHADER( ae_outliney_ps20 );
	}
	Draw();
}
END_SHADER